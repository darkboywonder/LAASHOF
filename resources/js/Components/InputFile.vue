...
<template>
    <div
        :class="[
            { 'bg-gray-50': disabled },
            'mt-1 rounded-md border-2 border-dashed border-gray-300 px-2 pt-5 pb-6',
        ]"
    >
        <div class="space-y-1 text-center">
            ...
            <div class="flex justify-center text-sm text-gray-600">
                <label
                    ...
                    :class="
                        ...
                        'relative text-center rounded-md font-medium focus-within:outline-none focus-within:ring-2 focus-within:ring-green-600 focus-within:ring-offset-2')
                    "
                >
            ...
            <p class="text-xs text-gray-500">PNG, JPG, GIF each up to 10MB</p>
            <div
                v-for="file in files"
            ...
            >
                <div class="flex space-x-2">
                    ...
                    <p class="flex flex-col">
                        <span class="text-left text-sm">{{ file.name }}</span>
                        <span class="text-left text-xs">{{ file.size }}</span>
                    </p>
                </div>
                <XCircleIcon
